(function ($) {
    ...
    var d = new Date;
    var date = d.getMonth()+ 1;//(d.getMonth()+ 1) '/'+d.getDate()+'/'+d.getFullYear();
        date += '/'+d.getDate();
        date += '/'+d.getFullYear();
        date += ' '+d.getHours();
        date += ':'+d.getMinutes();
    ...
    $.extend($.fn.bootstrapTable.defaults.icons, {
        print: 'glyphicon-print icon-print'
    });
            ...
            if (!$print.length) {
                ...
                $print.click(function () {
                    ...
                    var doPrint = function (data) {
                        ...
                        var table=buildTable(that.data,that.options.columns[0]);
                        console.log('that.options.columns[0] - > ',that);
